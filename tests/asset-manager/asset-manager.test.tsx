...
describe("asset-manager", () => {
  ...
  it("should handle WithdrawTo message correctly", () => {
    ...
    const { result } = simnet.callPublicFn(
      ...
      'handle-call-message',
      [
        Cl.stringAscii(ICON_ASSET_MANAGER), // Replace with the actual ICON_ASSET_MANAGER address
    ...
    // Assert the expected behavior, e.g., check if the transfer was successful
    // expect(receipts.length).toBe(1);
    // expect(receipts[0].result).toBeOk();
  });
  ...
  //   const { receipts } = simnet.callPublicFn(
  //     assetManager.contractName.content,
  //     'handle-call-message',
  //     [
  //       Cl.stringAscii('0x1234'), // Replace with the actual X_CALL_NETWORK_ADDRESS
  //       Cl.buffer(encodedData),
  //       Cl.list([]), // Replace with the actual default sources
  //     ],
  //     deployer!
  ...
  //     'handle-call-message',
  //     [
  //       Cl.stringAscii('0x5678'), // Different address, not ICON_ASSET_MANAGER
  //       Cl.buffer(encodedData),
  //       Cl.list([]), // Replace with the actual default sources
  //     ],
  //     deployer!
  ...
  //   expect(receipts[0].result).toBeErr(Cl.uint(100)); // ERR_UNAUTHORIZED
  // });
  ...
  //     'handle-call-message',
  //     [
  //       Cl.stringAscii('0x5678'), // Different address, not X_CALL_NETWORK_ADDRESS
  //       Cl.buffer(encodedData),
  //       Cl.list([]), // Replace with the actual default sources
  //     ],
  //     deployer!
  ...
  //     'handle-call-message',
  //     [
  //       Cl.stringAscii('0x1234'), // Replace with the actual ICON_ASSET_MANAGER address
  //       Cl.buffer(encodedData),
  //       Cl.list([]), // Replace with the actual default sources
  //     ],
  //     deployer!
  ...
  //   expect(receipts[0].result).toBeErr(Cl.stringAscii("Unknown message type"));
  // });
});
