...
;;                             (to-principal (principal-of? (unwrap-panic (as-max-len? (unwrap-panic (to-consensus-buff? to-address)) u33))))
;;                             (amount (get amount message))
;;                           )
;;                             (withdraw token-principal amount to-address)
;;                           )
;;                           (err ERR_UNAUTHORIZED)
;;                       )
;;                     )
;;                     (err (unwrap-err! message-result))
;;                 )
;;               )
...
;;                                   (let (
;;                                     (token-address (get token-address message))
;;                                     (token-principal (principal-of? token-address))
;;                                     (to-address (get to message))
;;                                     (to-principal (principal-of? to-address))
;;                                     (amount (get amount message))
;;                                   )
;;                                     (withdraw token-principal to amount)
;;                                   )
;;                                   (err ERR_UNAUTHORIZED)
;;                               )
;;                             )
